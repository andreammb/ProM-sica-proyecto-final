...
CREATE TABLE `encargado` (
  ...
  `Apellido1_Encargado` varchar(45) DEFAULT NULL,
  `Apellido2_Encargado` varchar(45) DEFAULT NULL,
  `Cedula_Encargado` varchar(45) DEFAULT NULL,
  `Tel_Encargado` varchar(45) DEFAULT NULL,
